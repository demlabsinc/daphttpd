...
ifneq ($(filter [x86GCC],$(xtarget)),)
	LOCAL_CFLAGS := -Wall -O3 -fno-ident -ffast-math -ftree-vectorize -mfpmath=sse -mmmx -msse2 -fno-asynchronous-unwind-tables -ffunction-sections -Wl,--gc-sections -Wl,--strip-all
	LOCAL_LFLAGS := -mconsole -static -fno-asynchronous-unwind-tables -ffunction-sections -Wl,--gc-sections -fno-ident -Wl,--strip-all
...
ifneq ($(filter [x86VCC] [x86_64VCC],$(xtarget)),)
	...
	LOCAL_LFLAGS := /SUBSYSTEM:CONSOLE /LIBPATH:[LIB]/$(xtarget)
endif
...
ifneq ($(filter [x86CLANG],$(xtarget)),)
	...
	LOCAL_CFLAGS := -Wall -mmmx -msse2 -O3 -Rpass=loop-vectorize -fvisibility=hidden -ffast-math -ftree-vectorize -mfpmath=sse -fno-asynchronous-unwind-tables -ffunction-sections 
	LOCAL_LFLAGS := -mconsole -static -fno-asynchronous-unwind-tables -ffunction-sections -Wl,--gc-sections -fno-ident -fno-asynchronous-unwind-tables -Wl,--strip-all
